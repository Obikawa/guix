...
(define-public ark
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1g05lyv8ll85myw0i62bxr4kmfd3dhldvmbgpgym9r1rgan12q90"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1hh7sql04hpwvb8hbi7snvh2d6922a2yraah9hd1jiwniv3cv175"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules kdoctools))
    (inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0vxssxchh23bl237qw9pznbrkwyqx1bhbnp2fq9baw1bn88d18i5"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules kdoctools))
    (inputs
