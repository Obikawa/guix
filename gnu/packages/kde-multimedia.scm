  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "17cyrimlnf1npffmxinnj3q5ynqg3agx35b55iqnw3xixrz4snzr"))))
    (build-system qt-build-system)
    (native-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1qgxpy1ksrgvdik69vppzdl1crscn69284q4wvwc5qh9v6rhv1xn"))))
    (build-system qt-build-system)
    (native-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0rjg3zs85gw62r3z3msp438jnf0ghc6y577br59ig19m10x33rz9"))))
    (build-system qt-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09qn1px0mmcjhw9ikaz8xcjbdabh657ij3sa4ps37jbfzyyv45fb"))))
    (build-system qt-build-system)
    (native-inputs
  ...
  (package
    ...
    (source
     (origin
      ...
      (sha256
       (base32 "0fyjzzv6x9xf0g222jjsvrywnm3blhbzm2zwhxagrfkjvjpb2cvk"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "08abnybd0fa0vvpaixi18ljfz0s8a5pmbblzpcc8rvwzdjc7az6q"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
