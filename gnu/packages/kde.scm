  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0z1p0s7fakfbscppmrgp1irf3dm2ayadyd3yb5zdsr9xahs0b9md"))))
    (build-system qt-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1srsm25qvbww0hl7r878n32b71g0p222zxyys7chzrg8izrh12b8"))))
    (build-system qt-build-system)
    (arguments
     `(#:phases
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0r3z9k900dm75r2gqhlpphvg71g0f8if500h941hxkdwy1pwhi40"))))
    (build-system qt-build-system)
    (arguments
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/release-service/" version
                           "/src/" name "-" version ".tar.xz"))
       (sha256
        (base32 "1k0bwyhk73gshc7f0j6mply2m9ykfd07mhkxwnzj874sby5rxhv9"))))
    (build-system qt-build-system)
...
(define-public poxml
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zzw9jwwd5nx12ma2ihffj6nhr3zlpahnj8k0r8mxcyn99j51kyn"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules kdoctools))
    (inputs
