  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0c0gk1djgl1d1qzibw5f1w29cnlxl6kan8pkg0izaqvnbmmx53wn"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09ddkc7kiayx852mpgdmv04l19vrrc0yrf30hnyzkci58kbavvcq"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public yakuake
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xkdyn944ga1xvwbbblnffvlnwgypspr909yvdy6xf5j0qaldsdk"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
