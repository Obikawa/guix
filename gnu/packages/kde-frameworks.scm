...
(define-public kdnssd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "17szlqsafz6p4h7s9wascaggn5909c1ig452wy6y4z4402s2lsrr"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kidletime
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xzwmk0aqv1lcdi51nl1k0lyiinnqxwla6w0xxmsh6193qa3fpvq"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public kirigami
  ...
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r48n11pv3yqsf11phl19cs52ph5ldabrfmq3xmsvxsknm6c4f9b"))))
...
(define-public kitemmodels
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0f7zlif7kskbwpw8yrzlfyl954b623icdd9qn0algjcc2i9gqbzi"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kplotting
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0i5ganvpzkpkd2p1avw0fpbp3mgbbifg8mmpvdf28ayh75dvrh9y"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public networkmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0i9wvrxbkbil21zndiq4cmnldbqsrdp9gnhmp2ns78xdih8wysa7"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules dbus pkg-config))
    (propagated-inputs
...
(define-public oxygen-icons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1izfh6cxivmwiymy7lwbmf9j1hxy2skv6z1lbjr0c4snmx6pqx1g"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules fdupes))
    (inputs
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05g1rydx0innmiz28mslix4bjsrhsnci227gadngzijncp2v288r"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public threadweaver
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1frhzlzmnrp5y3lrl0ahzxh8syj4vlkjvaypsmbm2bkkn4akizg3"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kactivities
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0wf7nnf3bjz2iq2wqxnyay1100ks0zscsh7sa8xfcijrl7pp305w"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kdoctools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1l2a9mlcm8np3s8myq0hj08l82284r90yhx3z2gn7h68b8fzyx0s"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kimageformats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r3ihkly0hf20aqbn7b9171mzqjna078rksdp96z6f7f1qy99v1v"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public kpty
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1p5ny9ry0wwwprhpj9s9xg96h9476rldly7mawvfp5q3ihys8c4a"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public syndication
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0a9j443w42jwvlzjh5mfxn25kwjrz1ya6sgy0c4y3n5xbg031zmx"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kdesu
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1q8k2q7c41fzw9gwx9nq4zjpjdwvh29zyh3zd0w3r2kxf6vhf1wp"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kpty))
    (native-inputs
...
(define-public knotifyconfig
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1qss40sr7az9x4yvl59mblzzgjm3hd8nvxgqmqlylargvggw496c"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kparts
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1x8kxd8kgzabd9dyqx2yx1qrrzl1mms4hm3lyg3f1nxki7xl6ra2"))))
    (build-system qt-build-system)
    (arguments
...
(define-public kpeople
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1632k365bn9n3n8babq620v0px2hmapk8fprx28xpfp27zakhfgw"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kwallet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06ffg84jvrc8xhymg1g5j311vq3ajfqg3arx2cxa98aqld213akl"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kde-frameworkintegration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1v7vlq2gk7j5b6gzbawgnpii7csh2zclp5v24qhx4qrmpfssylan"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             name "-" version ".tar.xz"))
       (sha256
        (base32 "1bi839x4dhlkqxmv98pq01725b8i8szdxf9b1hf1jv37fk468mja"))))
    (build-system qt-build-system)
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             name "-" version ".tar.xz"))
       (sha256
        (base32 "1z5d1ixzvaq6x9x0jhmh5bdrdqpsl1x7mh3s8wnycfxwmln6bawv"))))
    (build-system cmake-build-system)
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             name "-" version ".tar.xz"))
       (sha256
        (base32 "010m5qrn41hcxsmxsq72m83qxikfvn3mgibkgy4bn2x8kxibzmlq"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules kdoctools qttools))
    (inputs
